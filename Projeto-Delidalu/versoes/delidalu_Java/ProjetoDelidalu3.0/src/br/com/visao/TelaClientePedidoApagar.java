 ...
 * @author laboratorio
 */
public class TelaClientePedidoApagar extends javax.swing.JFrame {

    /**
     * Creates new form TelaClientePedido
     */
    public TelaClientePedidoApagar() {
        initComponents();
    }
    ...
    private void jBdeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBdeletarActionPerformed
        ...
        cp.setId_pedido(Integer.valueOf(jTidPedido.getText()));
        try {
            dao.deletar(cp);
            jTidPedido.setText("");
        } catch (Exception ex) {
            Logger.getLogger(TelaClientePedidoApagar.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaClientePedidoApagar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaClientePedidoApagar().setVisible(true);
            }
        });
    }
